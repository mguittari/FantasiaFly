...
VALUES (
        'Poudlard',
        'Scotland',
        'Embarquez pour Poudlard en compagnie de Henry, Aaron et Hermine. On augmente le prix du billet si vous êtes fan de l''univers.',
        50,
        'uploads/1712578931695-876118117-Poudlard.png'
    ),
    (
        'Ifrane',
        'Morocco',
        'Redécouvrez Winterfell comme si vous y étiez.',
        40,
        'uploads/1712578956255-428889354-Ifrane.png'
    ),
    (
        'Astapor',
        'Morocco',
        'Visitez la cité d''Astapor en compagnie de Daenerys comme un vrai touriste de passage au Maroc.',
        30,
        'uploads/1712578620497-190554078-Astapor.png'
    ),
    (
        'Twin Peaks',
        'USA',
        'Percez les mystères de Twin Peaks dans une expérience hors du commun.',
        60,
        'uploads/1712579004905-336890596-Twin.png'
    ),
    (
        'Planète des Singes',
        'Space',
        'Rejoignez une armée de singes et menez la rébellion contre la domination humaine.',
        35,
        'uploads/1712579031458-397918641-Singes.png'
    ),
    (
        'Anor Londo',
        'Lordran',
        'Plongez dans Dark Souls IRL et confrontez-vous à la mort. Aller simple uniquement...',
        1,
        'uploads/1712579099522-637720771-Londo.png'
    ),
    (
        'Astéroide B612',
        'Space',
        'Si vous aimez le Petit Prince vous allez adorer passer 3 jours sur un astéroïde vide et gelé.',
        5,
        'uploads/1712579114541-912240527-Astero.png'
    ),
    (
        'Hopital psychiatrique Briarcliff',
        'USA',
        'Faites-vous interner le temps d''un séjour inoubliable.',
        100,
        'uploads/1712579129700-629422774-Briarcliff.png'
    ),
    (
        'Loompaland',
        'Loompa (Pacific Ocean)',
        'Si vous avez aimé Charlie et la Chocolaterie et Super Mario Sunshine.',
        28,
        'uploads/1712579186776-26497043-Oompa.png'
    ),
    (
        'Westworld',
        'USA',
        'Vous avez toujours rêvé d''être un cowboy, un vrai ? Sensations garanties !',
        15,
        'uploads/1712579213368-353406905-Westworld.png'
    ),
    (
        'Plum Creek',
        'USA',
        'Baignez-vous dans la rivière de Plum Creek et rencontrez la famille Ingalls.',
        40,
        'uploads/1712579516894-36053817-Ingalls.png'
    ),
    (
        'Fenêtre d''azur',
        'Malta',
        'Baignez-vous dans la rivière de Plum Creek et rencontrez la famille Ingalls.',
        51,
        'uploads/1712579529995-57265564-Azur.png'
    ),
    (
        'Maison Picassiette',
        'France',
        'Falaises impressionnantes, plages cachées, temples mégalithiques aux mystérieuses légendes...',
        35,
        'uploads/1712579558138-539205857-Picassiette.png'
    ),
    (
        'Vice City',
        'USA',
        'Partez à la rencontre du banditisme et admirez des couchers de soleil rose et bleu toute la journée.',
        55,
        'uploads/1712579731978-735304598-Vice.png'
    );
INSERT INTO period (
        date_departure,
        date_return,
...
VALUES ('2025-01-01', '2025-01-05', 6, 350.00),
